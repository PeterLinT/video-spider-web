...
from .models import tv_play,movie_play


class Tvplay_Index(indexes.SearchIndex, indexes.Indexable):
    # 下面要搜索哪些数据配置就行了
...
class Movieplay_Index(indexes.SearchIndex, indexes.Indexable):
    # 下面要搜索哪些数据配置就行了
